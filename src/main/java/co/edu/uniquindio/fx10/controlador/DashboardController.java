...
public class DashboardController {
    ...
    private void onVolver (ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(App.class.getResource("/co/edu/uniquindio/fx10/vista/Vista/Inicio.fxml"));
            Parent inicio = loader.load();

            // (opcional) acceder al controlador de Inicio
